...
"""
The process_government_website_merger.py module preprocess the file
...
def main():
    ...
    # load merged CSV
    merger = pd.read_csv('201202-201809-central-government-websites-raw.csv')
    ...
    # save to file
    merge_filtered_year.to_csv('201202-201809-central-government-websites.csv')
