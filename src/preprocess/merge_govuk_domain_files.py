...
def main():
    ...
    extension = 'csv'
    all_filenames = [i for i in glob.glob('../data/**/*govuk-domain-names.{}'.format(extension))]
    ...
    # export to csv
    combined_csv.to_csv(
        "../data/processed/201210-202303-govuk-domain-names-processed.csv", index=False, encoding='utf-8-sig'
    )
